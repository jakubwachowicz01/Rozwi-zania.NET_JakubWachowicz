    ...
    public class Dane : INotifyPropertyChanged
    {
        ...
        public void Wykonaj()
        {
            ...
            if (działanie == "+")
                ...
                Wynik = Convert.ToString(pierwsza / druga);
            else if (działanie == "x^y")
                Wynik = Convert.ToString(Math.Pow((double)pierwsza, (double)druga));
            else if (działanie == "mod")
                Wynik = Convert.ToString(pierwsza % druga);
            else if (działanie == "sqrt")
                Wynik = Convert.ToString(Math.Sqrt((double)pierwsza));
            else if (działanie == "log10")
                Wynik = Convert.ToString(Math.Log10((double)pierwsza));
            else if (działanie == "x^2")
                Wynik = Convert.ToString(Math.Pow((double)pierwsza, 2));
            else if (działanie == "1/x")
                Wynik = Convert.ToString((double)1/ (double)pierwsza);
